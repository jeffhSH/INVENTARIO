    ...
    public class TipoProductoFrm extends DefaultFrm<TipoProducto, Long> implements Serializable {
        ...
        protected void crear(TipoProducto entidad) {
            System.out.println("🔍 CREAR - Nombre recibido: " + entidad.getNombre());
            System.out.println("🔍 CREAR - Nombre es vacío: " + (entidad.getNombre() == null || entidad.getNombre().trim().isEmpty()));
        ...
        public void btnNuevoTipoHandler() {
            ...
            cargarTiposPadre();
            // Asegurar que los combos estén actualizados
        }
